		...
		<table width="80%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td align="left" width="95%" style="font: 13px/18px Arial, Helvetica, sans-serif;">
					...
					<nobr><a href="<?php echo site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?>" style="color: #3366cc;"><?php echo site_url('/auth/activate/'.$user_id.'/'.$new_email_key); ?></a></nobr><br /><br />
					
					Please verify your email within <?php echo $activation_period; ?> hours, otherwise your registration will become invalid and you will have to register again.<br /><br /><br />
					
					
					<?php if (strlen($username) > 0): ?>Your username: <?php echo $username; ?><br /><?php endif; ?>
					Your email address: <?php echo $email; ?><br />
					<?php if (isset($password)): /* ?>Your password: <?php echo $password; ?><br /><?php */ endif; ?>
					<br /><br />
